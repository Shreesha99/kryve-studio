  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.fromTo(headlineSpans, 
        ...
        .fromTo(paragraphRef.current, { opacity: 0, y: 20 }, { opacity: 1, y: 0 }, "-=0.8")
        .fromTo(buttonRef.current, { opacity: 0, y: 20 }, { opacity: 1, y: 0 }, "-=0.8")
        .fromTo(
          svgRef.current,
        ...
        .fromTo(hintRef.current, { opacity: 0, y: 20 }, { opacity: 1, y: 0 }, "-=0.5");
    });
      ...
      <div className="container relative z-10 mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-24">
          <div className="text-left">
            ...
            <p
              ref={paragraphRef}
              className="mt-6 max-w-xl text-lg text-muted-foreground md:text-xl opacity-0"
            >
          ...
          <div className="relative overflow-hidden">
            <div
              ref={svgRef}
              className="relative aspect-[4/3] w-full max-w-2xl justify-self-center overflow-hidden rounded-lg lg:max-w-none opacity-0"
            >
              <MorphingSvg
                theme={resolvedTheme}
