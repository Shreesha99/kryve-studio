...
const jsonLd = {
  ...
  description:
    "The Elysium Project is a premium digital studio specializing in web design, development, and branding. We build beautiful, high-performance websites that drive results.",
  address: {
    "@type": "PostalAddress",
